 ...
 * @author ADM
 */
public class Domingo extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Domingo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
