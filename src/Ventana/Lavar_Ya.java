 ...
 * @author ADM
 */
public class Lavar_Ya extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Reserva.setText("Configuración de lavado");
        getContentPane().add(Reserva, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 70, -1, -1));
        ...
        getContentPane().add(Linea_Azul, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 120, 350, 10));
        ...
        getContentPane().add(btn_Cancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 620, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Lavar_Ya.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
